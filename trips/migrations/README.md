...
Эта папка содержит SQL миграции для базы данных сервиса trips.
...
```bash
export DATABASE_URL=postgresql://user:password@localhost:5432/zdrive_trips
```
...
```bash
cargo run --package trips --bin migrate
```
